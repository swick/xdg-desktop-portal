...
class TestUsb:
    ...
    def generate_device(self, testbed, vendor, vendor_name, product, product_name, serial):
        n = self._num_devices
        self._num_devices += 1
...
""")
    ...
    def test_device_add(self, portal_mock, app_id, usb_queries):
        ...
        if usb_queries == None:
            ...
            assert device
            assert device["readable"] == True
            assert device["writable"] == True
            ...
            assert device["properties"]["ID_SERIAL"] == "Canon_Inc._Canon_Digital_Camera_C767F1C714174C309255F70E4A7B2EE2"
    ...
    def test_acquire(self, portal_mock, app_id):
        ...
        (results, finished) = usb_intf.FinishAcquireDevices({})
